                        ...
                        {cart.map((product,index)=>(
                           ...
                           <td>
                            <div className='d-flex gap-1'>
                              <button onClick={()=>dispatch(incrementQuantity(product))} className="btn btn-success fw-bolder">+</button>
                              <input style={{width:'40px'}} className='form-control' type="text" value={product.quantity} readOnly />
                              <button onClick={()=>handleDecrementCart(product)} className="btn btn-danger fw-bolder">-</button>
                              </div> 
                              </td>
